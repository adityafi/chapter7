...
dashboardRouter.get("/dashboard/login", async function (req, res) {
...
dashboardRouter.get("/dashboard/home", async function (req, res) {
  ...
  res.render("dashboard/home", { users, error });
});
...
dashboardRouter.get("/dashboard/users/:id/delete", async function (req, res) {
  ...
  res.render("dashboard/users/delete", { user: currentUser });
});

dashboardRouter.get(
  "/dashboard/users/:id/histories",
